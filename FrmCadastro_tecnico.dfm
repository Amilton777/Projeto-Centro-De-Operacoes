object frm_cadastro_tecnico: Tfrm_cadastro_tecnico
  Left = 0
  Top = 0
  ...
  object Label1: TLabel
    ...
    Width = 137
    Height = 13
    Caption = 'CPF  (N'#195'O OBRIGADT'#211'RIO)'
  end
  object Label6: TLabel
    ...
    Width = 140
    Height = 13
    Caption = 'SENHA (N'#195'O OBRIGAT'#211'RIA)'
  end
  ...
  object DBEdit1: TDBEdit
    ...
    DataSource = frm_novo_tecnico.DS_CONSULTA_TECNICOS
    Enabled = False
    Font.Charset = DEFAULT_CHARSET
    Font.Color = clWindowText
    Font.Height = -13
