...
begin
   //Selecionar Os adicionais do serviço "Exemplo cabeamento longp"
...
begin
   //Abrindo formulçario de deslocamentos de cidades
   IF DM.QRY_Operacoes.RowsAffected >0 then
...
begin
    //Adicionais de serviços abrindo outro form.
    IF DM.QRY_Operacoes.RowsAffected >0 then
     Begin
...
begin
  ...
  //Verificando se é necessario atualizar
  ...
  begin
   ...
   //fim
    ...
    //Se a versão não for menor finalizar processo.
    begin
...
begin
  Try
    ...
    //Atualiza os adicionais do serviço exemplo RETIRADA DE PAINEL, CABEAMENTO LONGO.
    Adicionais();

    //Atualiza os Deslocamentos do serviço exemplo ANDRADINA/ NOVA INDEPENDENCIA.
    Deslocamentos();
...
begin
 //Extrair valores em tela para mandar para o técnico que não usa o app
  if DM.QRY_Operacoes.RowsAffected > 0 then
   begin
